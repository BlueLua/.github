...
- For inline API documentation changes, update the annotations under the
  `types/` directory (or the [docs] directory for manual tutorials and guides
  that are not autogenerated). Do not write documentation directly in the source
  code.
...
[docs]: https://github.com/BlueLua/bluelua.github.io/tree/main/docs/src
